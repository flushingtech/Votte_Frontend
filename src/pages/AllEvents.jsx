    ...
    >
      ...
      <div className="flex-1 px-4 sm:px-6 py-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="mb-6">
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">All Events</h1>
            <p className="text-gray-400">Manage all hackathon events</p>
          </div>

          <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-sm border border-slate-700/50 shadow-2xl p-6 min-h-[600px]">
