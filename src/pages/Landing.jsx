        ...
        <div className="max-w-7xl mx-auto w-full min-w-0 grid grid-cols-1 lg:grid-cols-[1.2fr_0.85fr] gap-12 lg:gap-16 items-center">
          ...
          <div className="min-w-0 text-center lg:text-left space-y-6 animate-fade-in">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight">
              Meet <span className="text-site_orange">Flushing Tech</span>
            </h1>
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3">
                {eventListings.map(({ name, href, color, Icon, image }) => (
                  <a
                    ...
                    aria-label={name}
                    title={name}
                    className="flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-site_orange/50 rounded-full pl-2 pr-4 py-2 transition-colors duration-300"
                  >
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md rounded-2xl p-[2px] overflow-hidden shadow-2xl shadow-black/50 bg-site_orange/50">
              ...
              <div className="relative bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-md rounded-2xl p-8">
