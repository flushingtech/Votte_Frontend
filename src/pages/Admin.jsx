              ...
              <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 border border-slate-700/50 shadow-2xl p-4 flex-shrink-0">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white px-4 py-3 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl flex items-center justify-between group"
                  >
                    ...
                    <span className="text-xs text-white/80 group-hover:text-white">Manage</span>
                  </button>
