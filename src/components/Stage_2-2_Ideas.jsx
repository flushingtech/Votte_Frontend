  ...
  return (
    <div
      ...
      style={{
        ...
        minHeight: "100vh", // ✅ Full height until content overflows
        overflowY: "auto", // ✅ Enables scrollbars for overflow
        boxSizing: "border-box", // Prevents padding and borders from affecting height
      }}
    >
      <h2
          ...
          {ideas.map((idea) => (
            ...
            >
              <div>
                ...
                <p
                  className={`text-xs ${
                    userVote === idea.id ? "text-gray-400" : "text-gray-300"
                  }`}
                >
                  {idea.description}
                </p>
